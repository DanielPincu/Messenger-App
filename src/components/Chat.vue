<template>
  <div class="flex flex-col md:flex-row container mx-auto mt-10 h-[550px] md:h-[600px] w-full bg-blue-400 shadow-xl border-blue-500 border-t-2 border-l-2 rounded-xl overflow-hidden">
    
    <!-- Sidebar for Online Users -->
    <div :class="['md:flex md:flex-col md:w-64', { 'hidden': !isSidebarOpen, 'absolute top-0 left-0 h-full w-3/4 bg-blue-500 z-50': isSidebarOpen }]">
      <h1 class="text-center text-3xl font-bold text-white">CHATOGNITO</h1>
      <button @click="toggleSidebar" class="md:hidden text-white">
         CLOSE
      </button>
      <div class="flex-1 p-4 bg-blue-200 md:bg-transparent overflow-y-auto">
